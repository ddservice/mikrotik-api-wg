    ...
    apps: [
        {
            ...
            env: {
                ...
                // ==========================================
                // หน้าเว็บที่ "/" จะเสิร์ฟ — 'v2' (หน้าใหม่, ค่าเริ่มต้น) หรือ 'v1' (หน้าเดิม)
                // ใส่ 'v1' ที่นี่เมื่อต้องการย้อนกลับ — มีผลทันทีหลัง pm2 reload
                //
                // /v1/ กับ /v2/ เข้าได้เสมอไม่ว่าตั้งค่าไหน การสลับกลับจึงแค่
                // ลบ/แก้บรรทัดนี้แล้ว pm2 reload — ไม่ต้อง deploy ใหม่ ไม่ต้องแตะ git
                // ==========================================
                // UI_DEFAULT: 'v1',
                ...
                // ==========================================
                // Cloudflare R2 / Off-site DB Backup
                // ==========================================
