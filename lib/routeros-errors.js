...
const POLICY_HINTS = {
    ...
    // อ่าน lease ใช้แค่ read แต่การจอง IP ถาวร / ลบ lease ต้องมี write
    dhcp: {
        need: ['read', 'write'],
        what: 'ดูและจัดการ DHCP lease',
        why: 'การดู lease ใช้สิทธิ์ read ส่วนการจอง IP ถาวรหรือลบ lease เป็นการแก้ค่าบนเราท์เตอร์'
    },
    reboot: {
        need: ['reboot'],
