...
//
// เดิมโค้ดชุดนี้ถูกคัดลอกไว้ทั้งใน db.js และ db-supabase.js ซึ่งเป็นรูปแบบเดียวกับ
// ที่ทำให้ bangkokToday ถูกแก้ไปแค่ชุดเดียวแล้วอีกชุดยังผิดอยู่ (2026-08-30)
// จึงย้ายมารวมไว้ที่นี่ที่เดียว
// ==========================================================================
...
/** รับได้ทั้ง 'YYYY-MM-DD' และ timestamp เต็ม — timestamp เต็มใช้ตามที่ส่งมา */
